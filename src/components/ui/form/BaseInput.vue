<template>
   <div class="base-input" :class="{ 'base-input-password': isPasswordInput }">
      <label v-if="label" class="form-label form-label--top" :for="id">
         {{ label }}
      </label>
      <div class="base-input__wrapper">
         <input class="base-input__control" :class="{ 'is-error': !!error }" :id="id" :type="computedType"
         ...
         <base-icon-button v-if="isPasswordInput" @click="tooglePasswordVisibility" class="base-input__button">
